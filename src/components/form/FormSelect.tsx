      ...
      render={({ field: { onChange, onBlur, value, ref }, fieldState: { error } }) => (
        <div className={cn("space-y-3 w-full", className)}>
          ...
          {isMounted ? (
            ...
            <div 
              className={cn(
                "w-full bg-surface-container-low animate-pulse",
                variant === "default" ? "h-[48px] rounded-xl border border-surface-container-highest/50" : "h-[48px] border-b-2 border-outline-variant"
              )}
            />
          )}
