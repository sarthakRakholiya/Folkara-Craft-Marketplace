...
import { Editorial } from "../exploreTypes";
...
export const EditorialCard = React.memo(
  ({ editorial, className }: EditorialCardProps) => {
    if (editorial.variant === "image-bg" && editorial.image) {
      return (
        <div
          className={cn(
            "relative overflow-hidden rounded-xl aspect-[3/4] flex items-end p-8 md:p-10 text-white group cursor-pointer",
            className,
          )}
        >
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h2 className="font-sans text-2xl md:text-3xl text-primary mb-6 leading-tight max-w-sm">
            {editorial.title}
          </h2>
