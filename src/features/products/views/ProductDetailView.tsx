...
export const ProductDetailView = ({ initialData, isFavorite = false }: ProductDetailViewProps) => {
  ...
  const mockRelated = [
    ...
    },
    {
      ...
      price: "₹3,900",
      imageUrl:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuCxBVyAmEVJHs4fERpd24d7TxI0iujpWoIwBGKBp9A2sVMbSKUwr7Y4Qdv5MDqkjRVcRbILLiMzyEC9HQIVsa9Iqd74iremvFzIC0YGmvjtG0ZyfaGQRYtfbK6GtBXrP15bPBnGpWzU8zcgKr4Jkep33L2AmjuflAwvrbJn7S-qGbrkxQALkSFu1GE9AeXjUiXz0VMe69bzrMobGy5_rZ3FQWxDUEvjXGOjrmUWVg_A5EE4kDfqHM_iMaZU0ZuaTuI0ejoeHkq1sMI",
    },
    {
      id: "rel4",
      ...
      price: "₹2,200",
      imageUrl:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDHhV6YulRI1jAXtQ-JuvdcIzMDWBnoIEbj447_qqStJMM_ij5y-62Vu9F9ChmcTV1QdngAfRswT_94GyTcK-Wtla_kr8948EljUJWtr6PI_C-HV9rZvnVPVQ4EDbAWusCdezdRx4T0Pz1fZayjGMZpz5WuWRAAVN0qRJd556txYkDT17uL2hR67QXk64-Mas7C9tChHO3jBVhFdxqLX2TS4vdnhmnk8NEGJoZkRB6dbqYbT6RhJb5xunDohUc2OvaiXVWcwL4X9yo",
    },
  ];
  ...
  const mockReviews = [
    {
      ...
      avatarUrl:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuCyEq0fkSmnxIhyFESgaI3luljNbcNxHZgQQWBFA_bRHkjk32jSyGUwZ2-0fmLWNcRdGGQfJWbnX05rnUqzl7nDyI3TGZmVf-pcOHCYlZGowIWs4Ko9uE4uzQkF5Wko51OeZSnDdKGIzU_PoPQgaZJgbDw-bPmSAAKKG28vn221tBQjLN5cqJFqg07GswCd0kJk1A2gJhTxcNJD3kjpcWT0Puf-cvwkcu1IxhXBGkU9UOGeGhdQA1dlZJGWJvrHbwld9DrZb9LxDvM",
    },
    {
      id: "rev2",
      author: "Julian R.",
  ...
  return (
    <main className="w-full bg-surface relative min-h-screen">
      ...
      <section className="max-w-container-max mx-auto px-margin-page py-6 md:py-12 flex flex-col md:flex-row gap-8 md:gap-gutter">
        ...
        <ProductInfo product={mappedProduct} initialIsFavorite={isFavorite} />
      </section>
